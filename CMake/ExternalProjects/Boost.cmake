...
set(GOICPZ_USE_Boost 1)
set(GOICPZ_USE_Boost_LIBRARIES ${GOICPZ_BOOST_LIBS})
...
string(REPLACE "^^" ";" GOICPZ_USE_Boost_LIBRARIES "${GOICPZ_USE_Boost_LIBRARIES}")

if(NOT DEFINED BOOST_ROOT AND NOT GOICPZ_USE_SYSTEM_Boost)
  ...
  if(GOICPZ_USE_Boost_LIBRARIES)
    string(REPLACE ";" "," _boost_libs "${GOICPZ_USE_Boost_LIBRARIES}")
    foreach(_boost_lib ${GOICPZ_USE_Boost_LIBRARIES})
  ...
  set(_boost_cxxflags )
  if(CMAKE_CXX_FLAGS OR GOICPZ_CXX11_FLAG)
    set(_boost_cxxflags "cxxflags=${GOICPZ_CXX11_FLAG} ${CMAKE_CXX_FLAGS}")
  endif()
  ...
  # Manual install commands (for a GOICPZ super-build install)
