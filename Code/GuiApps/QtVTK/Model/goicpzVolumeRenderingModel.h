...
#ifndef goicpzVolumeRenderingModel_h
#define goicpzVolumeRenderingModel_h

#include "goicpzQtVTKModelWin32ExportHeader.h"
...
*/
  class GOICPZ_QTVTKMODELWINEXPORT VolumeRenderingModel : public QObject
{
  Q_OBJECT
