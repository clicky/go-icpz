...
OPTION(GOICPZ_USE_KWSTYLE "Enable the use of KWStyle for checking coding style." OFF)
IF(GOICPZ_USE_KWSTYLE)
...
SET(KWSTYLE_CONFIGURATION_FILE 
  ${PROJECT_BINARY_DIR}/Utilities/KWStyle/GOICPZKWS.xml)

SET(KWSTYLE_GOICPZ_FILES_LIST
  ${PROJECT_BINARY_DIR}/Utilities/KWStyle/GOICPZFiles.txt)

SET(KWSTYLE_GOICPZ_OVERWRITE_FILE
  ${PROJECT_SOURCE_DIR}/Utilities/KWStyle/GOICPZOverwrite.txt )

#
# Configure the files
#
CONFIGURE_FILE(
  ${PROJECT_SOURCE_DIR}/Utilities/KWStyle/GOICPZFiles.txt.in
  ${KWSTYLE_GOICPZ_FILES_LIST})

CONFIGURE_FILE(
  ${PROJECT_SOURCE_DIR}/Utilities/KWStyle/GOICPZKWS.xml.in
...
SET(KWSTYLE_ARGUMENTS_CODE
  -xml ${KWSTYLE_CONFIGURATION_FILE} -v -D ${KWSTYLE_GOICPZ_FILES_LIST}
  -o ${KWSTYLE_GOICPZ_OVERWRITE_FILE} ${KWSTYLE_EDITOR_FORMAT}
  )

ADD_CUSTOM_COMMAND(
  OUTPUT  ${GOICPZ_BINARY_DIR}/KWStyleCodeReport.txt
  COMMAND ${KWSTYLE_EXECUTABLE}
  ARGS    ${KWSTYLE_ARGUMENTS_CODE}
  COMMENT "Coding Style Checker"
  )

ADD_CUSTOM_TARGET(StyleCheckCode DEPENDS ${GOICPZ_BINARY_DIR}/KWStyleCodeReport.txt)

ADD_TEST(KWStyle ${KWSTYLE_EXECUTABLE} ${KWSTYLE_ARGUMENTS_CODE})

ENDIF(KWSTYLE_FOUND)
ENDIF(KWSTYLE_EXECUTABLE)
ENDIF(GOICPZ_USE_KWSTYLE)
