...
OPTION(GOICPZ_USE_CPPCHECK "Enable the use of CppCheck for static analysis." OFF)
IF(GOICPZ_USE_CPPCHECK)
  ...
  IF(CPPCHECK_EXECUTABLE)
    ...
    IF(CPPCHECK_FOUND)
      ...
      #  Define file names
      #
      SET(CPPCHECK_GOICPZ_FILES_LIST
        ${PROJECT_BINARY_DIR}/Utilities/CppCheck/GOICPZFiles.txt)

      #
      # Configure the files
      #
      CONFIGURE_FILE(
        ${PROJECT_SOURCE_DIR}/Utilities/CppCheck/GOICPZFiles.txt.in
        ${CPPCHECK_GOICPZ_FILES_LIST})

      SET(CPPCHECK_ARGUMENTS_CODE
        --file-list=${CPPCHECK_GOICPZ_FILES_LIST}
      ...
      ADD_CUSTOM_COMMAND(
        OUTPUT  ${GOICPZ_BINARY_DIR}/CppCheckCodeReport.txt
        COMMAND ${CPPCHECK_EXECUTABLE}
        ARGS    ${CPPCHECK_ARGUMENTS_CODE}
        COMMENT "Coding Style Checker"
      )

      ADD_CUSTOM_TARGET(StaticallyAnalyzeCode DEPENDS ${GOICPZ_BINARY_DIR}/CppCheckCodeReport.txt)

      ADD_TEST(CppCheck ${CPPCHECK_EXECUTABLE} ${CPPCHECK_ARGUMENTS_CODE})

    ENDIF(CPPCHECK_FOUND)
  ENDIF(CPPCHECK_EXECUTABLE)
ENDIF(GOICPZ_USE_CPPCHECK)
